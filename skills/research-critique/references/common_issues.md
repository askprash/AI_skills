...
A catch-all reference for cross-cutting issues that don't fit cleanly into the family-specific checklists. Use alongside `statistical_pitfalls.md`, `figure_integrity.md`, and the author-side `author_integrity.md`.
...
**Your own AI-use disclosure**: see `author_integrity.md` — disclose AI assistance per the target venue's author policy, keep AI off the author list, and verify every AI-assisted citation.
