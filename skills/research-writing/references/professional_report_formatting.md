...
- **Journal manuscripts** → Use the main `research-writing` skill plus `references/journal_guidelines.md` and `references/toolchain.md` for journal-specific formatting
- **Conference papers** → Same: follow the venue's class file / author guide via `references/toolchain.md`
...
- `research-writing` (this skill) - For journal manuscripts and conference papers; see `references/journal_guidelines.md` and `references/toolchain.md`
- `research-schematics` - For conceptual/structural vector diagrams (system boundaries, pipelines, three-views)
- `research-figures` - For publication-quality, reproducible-from-code data figures
- `matplotlib` - For low-level, fully customized plotting
