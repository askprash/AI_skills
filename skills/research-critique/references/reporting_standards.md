...
For ML papers outside medicine, check against the NeurIPS reproducibility checklist and the ML reproducibility checklist (Pineau et al.): dataset and split documentation, compute/hardware reporting, seeds, hyperparameter search, error bars over runs, and a working code release.
